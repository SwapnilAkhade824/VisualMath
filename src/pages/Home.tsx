...
const Home = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (topic.trim()) {
      ...
      navigate("/visualize", { state: { topic } });
    } else {
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32 relative">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-primary via-primary to-accent bg-clip-text text-transparent">
            ...
            <form onSubmit={handleSubmit} className="max-w-2xl mx-auto mb-6">
              <div className="flex flex-col sm:flex-row gap-3 p-2 bg-card rounded-2xl card-shadow">
                ...
                <Button 
                  type="submit"
                  size="lg"
                  className="gradient-primary font-semibold h-14 px-8 hover:opacity-90 transition-opacity"
                >
            ...
            <div className="flex flex-wrap justify-center gap-2">
              ...
              {exampleTopics.map((example) => (
                <Button
                  ...
                  className="text-sm hover:border-primary hover:text-primary transition-colors"
                >
                  {example}
                </Button>
              ))}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <Card 
                key={index}
                className="p-8 text-center hover:card-shadow-hover transition-all duration-300 hover:-translate-y-1 animate-scale-in border-border/50"
